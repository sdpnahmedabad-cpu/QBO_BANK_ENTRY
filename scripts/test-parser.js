...
console.log('Testing PDF parser API...\n');
    ...
    res.on('end', () => {
        ...
        try {
            ...
            if (parsed.transactions) {
                console.log('\n✅ SUCCESS! Extracted', parsed.transactions.length, 'transactions');
            } else if (parsed.error) {
                console.log('\n❌ ERROR:', parsed.error);
                if (parsed.details) console.log('Details:', parsed.details);
                if (parsed.suggestion) console.log('Suggestion:', parsed.suggestion);
            }
        } catch (e) {
            console.log(rawData);
        }
